...
(function (root) {
  ...
  const MODEL_ROWS = [
    ...
    ["bbBreakaway", ["Hop breakaway force", "Sila pokretanja kroz hop"], ["Force gauge", "Mjerač sile"]],
    ["barrelDrag", ["Moving BB resistance", "Otpor gibanja BB-a"], ["Force / velocity experiment", "Pokus sile / brzine"]],
    ["heatTransfer", ["Gas heat conductance", "Toplinska vodljivost plina"], ["Transient fit", "Prilagodba prijelaznog procesa"]],
    ["ambientPressure", ["Atmospheric pressure", "Atmosferski tlak"], ["Barometer", "Barometar"]],
    ["airTemperature", ["Air / wall temperature", "Temperatura zraka / stijenke"], ["Thermometer", "Termometar"]],
    ["usefulFraction", ["Useful-energy threshold", "Prag korisne energije"], ["Analysis convention", "Dogovor analize"]],
    ["decelThreshold", ["Strong-deceleration threshold", "Prag snažnog usporavanja"], ["Analysis convention", "Dogovor analize"]],
    ["maxTime", ["Maximum modeled time", "Najdulje modelirano vrijeme"], ["Solver limit", "Granica rješavača"]]
  ];
  ...
  const api = { markup, fieldValue, PART_FIELDS, MODEL_FIELDS: MODEL_ROWS.map(row => row[0]) };
  if (typeof module !== "undefined" && module.exports) module.exports = api;
