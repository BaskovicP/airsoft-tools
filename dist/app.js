...
(function (root) {
  ...
  function soundMarkup(s, baseline, t, fmt) {
    ...
    return `<section id="soundExplanations" class="sound-explanations" tabindex="-1" aria-label="${t("Piston impact and muzzle blast explained", "Objašnjenje udara pistona i praska na ustima")}">
      ...
      <p>${t("Actual sound also depends on bumper material, spring vibration and receiver/stock resonance. No dB or durability prediction.", "Stvarni zvuk ovisi i o materijalu odbojnika, vibraciji opruge te rezonanciji kućišta i kundaka. Ovo nije predviđanje dB ni trajnosti.")}</p>
      <p class="sound-measured">${t("First-contact speed", "Brzina pri prvom kontaktu")}: <strong>${fmt(q.impact === null ? null : s.pistonImpactVelocity, 2, "m/s")}</strong></p></article>
...
(() => {
  ...
  function optimizerMarkup() {
    ensureOptimizer();
    const labels = { cylinder: ["Cylinder", "Cilindar"], barrel: ["Barrel", "Cijev"], head: ["Head / nozzle", "Glava / mlaznica"], piston: ["Piston", "Piston"], airbrake: ["Airbrake", "Zračna kočnica"], spring: ["Spring", "Opruga"], bb: ["BB", "BB"] };
